...
\begin{tikzpicture}[
  ...
  \draw[arr] (shd) -- (px);
\end{tikzpicture}
\caption{Potok wizualizacji: od listy cząsteczek SPH do końcowego koloru piksela. Źródło: Opracowanie własne}
...
konieczności synchronizacji. Wynikiem etapu splatting --- rzutowania cząsteczek na siatkę wokseli (ang.~splatting) --- jest trójwymiarowa tekstura
