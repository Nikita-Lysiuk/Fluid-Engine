...
\texttt{Pipelines}         & GPU          & Potoki graficzne: niebo, cząsteczki, woda (przemarsz promienia, ang. Raymarching), granice \\
\bottomrule
\end{tabular}
\end{table}
...
\texttt{ELEMENTS\_PER\_INVOCATION}). Każdy wątek wyodrębnia $b$-bitową cyfrę z
...
zapobiega ucieczce cząsteczek poza granice sześcianu symulacji i jest wystarczające dla
