...
Rozbieżność między izolowanym benchmarkiem (gdzie radix dla $N = 2^{15}$ jest
...
Szader \texttt{density\_and\_alpha.comp} oblicza w jednym przebiegu dwie
...
\begin{lstlisting}[caption={Szader \texttt{density\_and\_alpha.comp} --- logika akumulacji},
